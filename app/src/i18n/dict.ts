export const dict = {
  vi: {
    ...
    'plan.pickGroup': 'Nhóm',
    'plan.errCategoryName': 'Nhập tên category',
    'plan.errPickGroup': 'Chọn một nhóm',
    'plan.renameTip': 'Bấm để đổi tên',
    'plan.delete': 'Xóa',
    'plan.deleteCategoryTip': 'Xóa category',
    'plan.deleteCategoryTitle': 'Xóa category "{name}"?',
    'plan.deleteCategoryDesc': 'Category sẽ bị ẩn khỏi Plan. Lịch sử giao dịch được giữ nguyên.',
    'plan.deleteGroupTip': 'Xóa nhóm',
    'plan.deleteGroupTitle': 'Xóa nhóm "{name}"?',
    'plan.deleteGroupDesc': 'Nhóm sẽ bị ẩn khỏi Plan.',
    'plan.deleteGroupBlockedTitle': 'Nhóm còn category',
    'plan.deleteGroupBlockedDesc': 'Xóa hoặc chuyển hết category trong nhóm trước, rồi mới xóa nhóm.',
  ...
  en: {
    ...
    'plan.pickGroup': 'Group',
    'plan.errCategoryName': 'Enter a category name',
    'plan.errPickGroup': 'Pick a group',
    'plan.renameTip': 'Click to rename',
    'plan.delete': 'Delete',
    'plan.deleteCategoryTip': 'Delete category',
    'plan.deleteCategoryTitle': 'Delete category "{name}"?',
    'plan.deleteCategoryDesc': 'The category will be hidden from Plan. Transaction history is kept.',
    'plan.deleteGroupTip': 'Delete group',
    'plan.deleteGroupTitle': 'Delete group "{name}"?',
    'plan.deleteGroupDesc': 'The group will be hidden from Plan.',
    'plan.deleteGroupBlockedTitle': 'Group is not empty',
    'plan.deleteGroupBlockedDesc': 'Delete or move all categories in this group first, then delete the group.',
